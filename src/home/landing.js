  ...
  return (
    <>
      <div className='flex flex-wrap md:flex-nowrap justify-around align-middle items-center'>
        <div className='ml-20'>
          <h2 className='text-3xl mt-5 xxl:text-5xl font-manrope leading-loose font-black'>
          ...
          <Link
            to='/login'
            className='block w-1/3 transform hover:scale-105 mt-20 rounded-md bg-primary outline-none px-5 py-3 text-white xxl:px-10 xxl:py-5'
          >
            Get Started for Merchants
          </Link>
        </div>

        <img className='xxl:mt-20 mt-10' src={homeImg} alt='landing' />
      </div>
      <div className='flex items-center justify-center w-2/5 mb-5 mx-auto shadow-xl p-8'>
        ...
        <button className='rounded-md bg-primary outline-none px-5 py-3 transform hover:scale-105 text-white xxl:px-10 xxl:py-5'>
          Find Merchant
        </button>
      </div>
    </>
